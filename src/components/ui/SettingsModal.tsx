...
function CustomThemeEditor() {
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `vireostudio-theme-${Date.now()}.json`;
  ...
  return (
    <div className="flex flex-col items-center text-center py-6 gap-4">
      <div className="w-16 h-16 flex items-center justify-center relative">
        ...
        <img src="/vireostudio.svg" alt="VireoStudio Logo" className="w-16 h-16 object-contain relative z-10 drop-shadow-xl" />
      </div>
      <div>
        <h3 className="text-lg font-bold text-text-primary">VireoStudio</h3>
        ...
        <div className="flex flex-col items-center gap-1.5 w-full">
          {!isDesktop ? (
            ...
            <>
              {updateStatus === "idle" && (
                <>
                  <p className="text-[11px] text-text-muted mb-2">Keep VireoStudio running at peak performance.</p>
                  <button
              ...
              {updateStatus === "up-to-date" && (
                <div className="flex flex-col items-center gap-2 py-1">
                  ...
                  <p className="text-xs text-green-400 font-medium">VireoStudio is up to date</p>
      ...
      <div className="flex items-center gap-4 mt-2">
        <button onClick={() => openUrl("https://github.com/AIEraDev/vireostudio")} className="text-xs font-medium text-text-muted hover:text-accent transition-colors flex items-center gap-1.5">
