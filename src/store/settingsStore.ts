...
export const CLIP_PALETTES: Record<ClipPalette, ClipPaletteTokens> = {
  ...
  dark: {
    ...
    "--color-timeline-clip-envelope-fill": "rgba(90, 184, 212, 0.34)",
  ...
  midnight: {
    ...
    "--color-timeline-clip-envelope-fill": "rgba(91, 143, 255, 0.34)",
  ...
  ocean: {
    ...
    "--color-timeline-clip-envelope-fill": "rgba(61, 184, 217, 0.34)",
  ...
  forest: {
    ...
    "--color-timeline-clip-envelope-fill": "rgba(82, 200, 130, 0.34)",
  ...
  "midnight-carbon": {
    ...
    "--color-timeline-clip-envelope-fill": "rgba(93, 182, 214, 0.34)",
  ...
  "ember-studio": {
    ...
    "--color-timeline-clip-envelope-fill": "rgba(217, 138, 80, 0.34)",
  ...
  "forest-console": {
    ...
    "--color-timeline-clip-envelope-fill": "rgba(110, 191, 139, 0.34)",
  ...
  "slate-noir": {
    ...
    "--color-timeline-clip-envelope-fill": "rgba(107, 169, 196, 0.34)",
  ...
  "rose-cut": {
    ...
    "--color-timeline-clip-envelope-fill": "rgba(217, 112, 151, 0.34)",
