...
const themes: Record<Exclude<Theme, "custom">, Record<string, string>> = {
  dark: {
    ...
    "--color-danger": "#e26061",
    "--color-video-clip": "#173745",
    "--color-audio-clip": "#16382f",
    "--color-text-clip": "#5b3b2e",
    // Guides & Indicators
    ...
    "--color-timeline-clip-audio-solid": "#287a5c",
    ...
    "--color-timeline-text-clip-bg": "#5b3b2e",
    "--color-timeline-text-clip-text": "#f7e7df",
